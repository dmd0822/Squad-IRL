/**
 * Dashboard Designer — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'DataStoryteller', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'UXExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Dashboard Designer\n');
  console.log('👥 Audience: 📊 Data/Business');
  console.log('📋 Problem: Design effective dashboard layouts that tell data stories\n');
