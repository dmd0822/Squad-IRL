/**
 * College App Coach — Squad SDK Sample
 *
 * Guide students through college application process with timeline and essay help
 *
 * Audience: 🎓 Students
...
const AGENTS = [
  { name: 'Advisor', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'EssayCoach', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Cheerleader', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 College App Coach\n');
  console.log('👥 Audience: 🎓 Students');
  console.log('📋 Problem: Guide students through college application process with timeline and essay help\n');
