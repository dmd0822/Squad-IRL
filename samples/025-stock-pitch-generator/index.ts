/**
 * Stock Pitch Generator — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'Skeptic', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Reporter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Stock Pitch Generator\n');
  console.log('👥 Audience: 💰 Finance');
  console.log('📋 Problem: Research and write investment thesis documents for potential stock picks\n');
