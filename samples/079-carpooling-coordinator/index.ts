/**
 * Carpooling Coordinator — Squad SDK Sample
 *
 * Organize carpool schedules that balance fairness and logistics
 *
 * Audience: 🚗 Commuters/Parents
...
const AGENTS = [
  { name: 'Scheduler', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'RouteOptimizer', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'FairnessJudge', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Carpooling Coordinator\n');
  console.log('👥 Audience: 🚗 Commuters/Parents');
  console.log('📋 Problem: Organize carpool schedules that balance fairness and logistics\n');
