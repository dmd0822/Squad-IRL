/**
 * Influencer Outreach Drafter — Squad SDK Sample
 *
 * Draft personalized influencer partnership pitches that get responses
 *
 * Audience: 📱 Social Media/Business
...
const AGENTS = [
  { name: 'Networker', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ValueProposer', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'RelationshipBuilder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Influencer Outreach Drafter\n');
  console.log('👥 Audience: 📱 Social Media/Business');
  console.log('📋 Problem: Draft personalized influencer partnership pitches that get responses\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Influencer Outreach Drafter`,
    `- **Audience:** 📱 Social Media/Business`,
