/**
 * Medication Reminder System — Squad SDK Sample
 *
 * Organize medication schedules with reminders and refill tracking
 *
 * Audience: 👵 Seniors/Health
...
const AGENTS = [
  { name: 'MedOrganizer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ReminderBot', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'RefillTracker', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Medication Reminder System\n');
  console.log('👥 Audience: 👵 Seniors/Health');
  console.log('📋 Problem: Organize medication schedules with reminders and refill tracking\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Medication Reminder System`,
    `- **Audience:** 👵 Seniors/Health`,
