/**
 * Instagram Caption Perfecter — Squad SDK Sample
 *
 * Write scroll-stopping Instagram captions with strategic hashtags
 *
...
const AGENTS = [
  ...
  { name: 'HashtagStrategist', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'EngagementExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Instagram Caption Perfecter\n');
  console.log('👥 Audience: 📱 Social Media');
  console.log('📋 Problem: Write scroll-stopping Instagram captions with strategic hashtags\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Instagram Caption Perfecter`,
    `- **Audience:** 📱 Social Media`,
