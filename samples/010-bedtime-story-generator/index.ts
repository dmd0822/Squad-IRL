/**
 * Bedtime Story Generator — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'MoralGuide', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
...
async function main(): Promise<void> {
  ...
  console.log('📋 Problem: Create custom bedtime stories featuring your kids as heroes\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Bedtime Story Generator`,
    `- **Audience:** 👩‍👧‍👦 Parents`,
