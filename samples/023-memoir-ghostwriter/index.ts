/**
 * Memoir Ghostwriter — Squad SDK Sample
 *
 * Interview-based memoir writing that captures personal stories
 *
 * Audience: 👵 Seniors
...
const AGENTS = [
  { name: 'Interviewer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Storyteller', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'FactChecker', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Memoir Ghostwriter\n');
  console.log('👥 Audience: 👵 Seniors');
  console.log('📋 Problem: Interview-based memoir writing that captures personal stories\n');
