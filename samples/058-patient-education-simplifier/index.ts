/**
 * Patient Education Simplifier — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Doctor', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Translator', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'EmpathyBot', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Patient Education Simplifier\n');
  console.log('👥 Audience: 🏥 Healthcare');
  console.log('📋 Problem: Translate medical jargon into patient-friendly education materials\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Patient Education Simplifier`,
    `- **Audience:** 🏥 Healthcare`,
