/**
 * Injury Recovery Tracker — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'PhysioGuide', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ProgressMonitor', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'TimelineBuilder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Injury Recovery Tracker\n');
  console.log('👥 Audience: 🏃 Fitness/Health');
  console.log('📋 Problem: Track rehab exercises and progress with return-to-activity timeline\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Injury Recovery Tracker`,
    `- **Audience:** 🏃 Fitness/Health`,
