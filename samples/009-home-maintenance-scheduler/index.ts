/**
 * Home Maintenance Scheduler — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'Inspector', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Planner', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Home Maintenance Scheduler\n');
  console.log('👥 Audience: 🏠 Homeowners');
  console.log('📋 Problem: Generate yearly home maintenance calendar with seasonal tasks\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Home Maintenance Scheduler`,
    `- **Audience:** 🏠 Homeowners`,
