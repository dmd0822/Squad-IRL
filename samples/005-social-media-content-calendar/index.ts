/**
 * Social Media Content Calendar — Squad SDK Sample
 *
 * Generate 30 days of on-brand social posts with captions and hashtags
 *
...
const AGENTS = [
  { name: 'Creator', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'BrandVoice', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Strategist', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  ...
  console.log('📋 Problem: Generate 30 days of on-brand social posts with captions and hashtags\n');
