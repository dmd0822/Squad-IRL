/**
 * Invoice Follow Up Automator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Collector', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'DiplomatBot', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'EscalationExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Invoice Follow Up Automator\n');
  console.log('👥 Audience: 🏪 Small Business');
  console.log('📋 Problem: Draft polite but firm invoice follow-up emails escalating appropriately\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Invoice Follow Up Automator`,
    `- **Audience:** 🏪 Small Business`,
