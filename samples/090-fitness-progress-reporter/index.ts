/**
 * Fitness Progress Reporter — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Analyst', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Motivator', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ProgramAdjuster', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Fitness Progress Reporter\n');
  console.log('👥 Audience: 🏃 Fitness');
  console.log('📋 Problem: Generate weekly fitness progress reports with insights and adjustments\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Fitness Progress Reporter`,
    `- **Audience:** 🏃 Fitness`,
