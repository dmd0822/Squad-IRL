...
You are improving a shift handoff notes generator that received feedback from a grader.
...
- Improve safety highlighting if critical info is buried
- Add missing patient information categories
- Strengthen prioritization of urgent items
- Enhance clarity and standardization of format
