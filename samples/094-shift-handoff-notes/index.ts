/**
 * Shift Handoff Notes — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Nurse', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'DetailCapture', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'PriorityHighlighter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Shift Handoff Notes\n');
  console.log('👥 Audience: 🏥 Healthcare');
  console.log('📋 Problem: Create comprehensive shift handoff notes for patient continuity\n');
