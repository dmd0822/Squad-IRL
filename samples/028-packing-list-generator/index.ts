/**
 * Packing List Generator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'TravelPro', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'WeatherAnalyst', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'MinimalistCoach', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Packing List Generator\n');
  console.log('👥 Audience: ✈️ Travelers');
  console.log('📋 Problem: Custom packing lists based on destination, duration, weather, and activities\n');
