/**
 * Expense Categorizer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Accountant', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Detective', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Auditor', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Expense Categorizer\n');
  console.log('👥 Audience: 💰 Finance/Everyone');
  console.log('📋 Problem: Automatically categorize and analyze monthly spending from bank exports\n');
