/**
 * Closet Capsule Designer — Squad SDK Sample
 *
 * Build minimalist capsule wardrobes from existing clothes
 *
 * Audience: 🎨 Fashion/Everyone
...
const AGENTS = [
  { name: 'Stylist', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ColorCoordinator', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'MixMatchExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Closet Capsule Designer\n');
  console.log('👥 Audience: 🎨 Fashion/Everyone');
  console.log('📋 Problem: Build minimalist capsule wardrobes from existing clothes\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Closet Capsule Designer`,
    `- **Audience:** 🎨 Fashion/Everyone`,
