/**
 * Garden Planting Guide — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Gardener', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ClimateExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'SuccessCoach', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Garden Planting Guide\n');
  console.log('👥 Audience: 🏠 Homeowners/Hobbyists');
  console.log('📋 Problem: Create personalized garden plans based on climate zone, space, and skill level\n');
