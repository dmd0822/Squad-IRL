/**
 * Dog Training Plan — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'BehavioristBot', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
...
async function main(): Promise<void> {
  console.log('🚀 Dog Training Plan\n');
  console.log('👥 Audience: 🐕 Pet Owners');
  console.log('📋 Problem: Personalized dog training programs for specific behavioral goals\n');
