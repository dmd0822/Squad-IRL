/**
 * Vendor Contract Reviewer — Squad SDK Sample
 *
 * Review vendor contracts for red flags and missing clauses
 *
 * Audience: 👰 Event Planners/Business
...
const AGENTS = [
  { name: 'Lawyer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'RedFlagSpotter', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'NegotiationAdvisor', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Vendor Contract Reviewer\n');
  console.log('👥 Audience: 👰 Event Planners/Business');
  console.log('📋 Problem: Review vendor contracts for red flags and missing clauses\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Vendor Contract Reviewer`,
    `- **Audience:** 👰 Event Planners/Business`,
