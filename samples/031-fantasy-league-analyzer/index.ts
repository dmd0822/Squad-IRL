/**
 * Fantasy League Analyzer — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'StatNerd', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'MatchupExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Fantasy League Analyzer\n');
  console.log('👥 Audience: 🎮 Gamers/Sports');
  console.log('📋 Problem: Weekly fantasy team analysis with trade suggestions and lineup optimization\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Fantasy League Analyzer`,
    `- **Audience:** 🎮 Gamers/Sports`,
