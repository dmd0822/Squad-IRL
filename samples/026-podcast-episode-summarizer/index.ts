/**
 * Podcast Episode Summarizer — Squad SDK Sample
 *
 * Listen to podcasts and generate actionable summaries with timestamps
 *
 * Audience: 📱 Content/Everyone
...
const AGENTS = [
  { name: 'Listener', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'KeyPointExtractor', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ActionItemFinder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Podcast Episode Summarizer\n');
  console.log('👥 Audience: 📱 Content/Everyone');
  console.log('📋 Problem: Listen to podcasts and generate actionable summaries with timestamps\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Podcast Episode Summarizer`,
    `- **Audience:** 📱 Content/Everyone`,
