/**
 * Parent Email Drafter — Squad SDK Sample
 *
 * Write professional parent communication emails that build partnerships
 *
 * Audience: 🏫 Teachers
...
const AGENTS = [
  { name: 'Communicator', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ToneManager', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'SolutionFocuser', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Parent Email Drafter\n');
  console.log('👥 Audience: 🏫 Teachers');
  console.log('📋 Problem: Write professional parent communication emails that build partnerships\n');
