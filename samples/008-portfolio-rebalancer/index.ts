/**
 * Portfolio Rebalancer — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'RiskManager', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'TaxOptimizer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  ...
  console.log('📋 Problem: Analyze current holdings and suggest trades to reach target allocation\n');
