/**
 * Essay Polisher — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Editor', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'CriticBot', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'StyleGuide', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Essay Polisher\n');
  console.log('👥 Audience: 🎓 Students');
  console.log('📋 Problem: Transform rough drafts into polished essays that meet rubric requirements\n');
