/**
 * Tech Support Simplifier — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'TechExplainer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PatientTeacher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'JargonEliminator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Tech Support Simplifier\n');
  console.log('👥 Audience: 👵 Seniors/Everyone');
  console.log('📋 Problem: Translate tech instructions into step-by-step guides with screenshots\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Tech Support Simplifier`,
    `- **Audience:** 👵 Seniors/Everyone`,
