/**
 * Ev Charging Optimizer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'RouteOptimizer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ChargerFinder', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'CostCalculator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Ev Charging Optimizer\n');
  console.log('👥 Audience: 🚗 EV Owners');
  console.log('📋 Problem: Plan EV charging stops for trips with cost and time optimization\n');
