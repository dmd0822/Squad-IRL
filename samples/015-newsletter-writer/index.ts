/**
 * Newsletter Writer — Squad SDK Sample
 *
 * Transform business updates into engaging email newsletters
 *
...
const AGENTS = [
  ...
  { name: 'CTAExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  ...
  console.log('📋 Problem: Transform business updates into engaging email newsletters\n');
