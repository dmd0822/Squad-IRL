/**
 * Insurance Denial Appeal — Squad SDK Sample
 *
 * Draft medical insurance denial appeals with supporting documentation
 *
 * Audience: 🏥 Healthcare/Everyone
...
const AGENTS = [
  { name: 'AdvocateBot', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PolicyExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'AppealWriter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Insurance Denial Appeal\n');
  console.log('👥 Audience: 🏥 Healthcare/Everyone');
  console.log('📋 Problem: Draft medical insurance denial appeals with supporting documentation\n');
