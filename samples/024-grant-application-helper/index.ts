/**
 * Grant Application Helper — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'GrantWriter', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'AlignmentChecker', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ImpactStoryteller', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Grant Application Helper\n');
  console.log('👥 Audience: 🎨 Artists/Nonprofits');
  console.log('📋 Problem: Write compelling grant applications that align with funder priorities\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Grant Application Helper`,
    `- **Audience:** 🎨 Artists/Nonprofits`,
