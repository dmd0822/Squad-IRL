/**
 * Zero Waste Swap Finder — Squad SDK Sample
 *
 * Identify eco-friendly product swaps for everyday items
 *
...
const AGENTS = [
  { name: 'EcoExpert', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ProductResearcher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ImpactCalculator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Zero Waste Swap Finder\n');
  console.log('👥 Audience: 🌱 Environmental');
  console.log('📋 Problem: Identify eco-friendly product swaps for everyday items\n');
