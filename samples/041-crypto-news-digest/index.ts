/**
 * Crypto News Digest — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'BSDetector', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'TrendSpotter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Crypto News Digest\n');
  console.log('👥 Audience: 💰 Finance');
  console.log('📋 Problem: Daily crypto news summary filtering signal from noise\n');
