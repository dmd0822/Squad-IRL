...
You are improving a restaurant review summarizer that received feedback from a grader.
...
- Add more specific dish-level insights if too general
- Improve temporal analysis (recent trends)
- Strengthen verdict with clearer confidence indicators
- Enhance actionability with practical dining tips
