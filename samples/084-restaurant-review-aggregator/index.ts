/**
 * Restaurant Review Aggregator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'ReviewReader', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'TrendSpotter', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'RecommendationEngine', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Restaurant Review Aggregator\n');
  console.log('👥 Audience: 🍳 Foodies');
  console.log('📋 Problem: Summarize restaurant reviews into decision-making guides\n');
  ...
  while (grade < GRADE_THRESHOLD && iteration < MAX_ITERATIONS) {
    ...
    // ── Update Phase ──
    console.log('\n🔄 RecommendationEngine improving...');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Restaurant Review Aggregator`,
    `- **Audience:** 🍳 Foodies`,
