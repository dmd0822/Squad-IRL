...
const AGENTS = [
  ...
  { name: 'Nutritionist', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Shopper', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Meal Prep Squad\n');
  console.log('👥 Audience: 👩‍👧‍👦 Parents/Families');
  console.log('📋 Problem: Weekly meal planning with nutrition goals, budget constraints, and picky eaters\n');
