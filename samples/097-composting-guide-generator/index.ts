/**
 * Composting Guide Generator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'CompostExpert', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'SetupAdvisor', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'TroubleshootBot', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Composting Guide Generator\n');
  console.log('👥 Audience: 🌱 Environmental');
  console.log('📋 Problem: Create personalized composting guides for space, climate, and goals\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Composting Guide Generator`,
    `- **Audience:** 🌱 Environmental`,
