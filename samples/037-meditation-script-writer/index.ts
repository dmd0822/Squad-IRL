/**
 * Meditation Script Writer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'MindfulnessGuide', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'VoiceCoach', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'IntentionSetter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Meditation Script Writer\n');
  console.log('👥 Audience: 🏃 Health/Wellness');
  console.log('📋 Problem: Generate custom guided meditation scripts for specific needs\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Meditation Script Writer`,
    `- **Audience:** 🏃 Health/Wellness`,
