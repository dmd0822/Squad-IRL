/**
 * Product Description Generator — Squad SDK Sample
 *
 * Write SEO-optimized product descriptions that convert browsers to buyers
 *
...
const AGENTS = [
  ...
  { name: 'ConversionOptimizer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Product Description Generator\n');
  console.log('👥 Audience: 🏪 Small Business');
  console.log('📋 Problem: Write SEO-optimized product descriptions that convert browsers to buyers\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Product Description Generator`,
    `- **Audience:** 🏪 Small Business`,
