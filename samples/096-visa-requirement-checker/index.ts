/**
 * Visa Requirement Checker — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'TravelExpert', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'DocumentChecker', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
...
async function main(): Promise<void> {
  console.log('🚀 Visa Requirement Checker\n');
  console.log('👥 Audience: ✈️ Travelers');
  console.log('📋 Problem: Research visa requirements and application checklists for travel\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Visa Requirement Checker`,
    `- **Audience:** ✈️ Travelers`,
