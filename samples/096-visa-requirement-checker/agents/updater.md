...
You are improving a visa requirement checker that received feedback from a grader.
...
- Verify accuracy of visa requirements (they change frequently)
- Add missing required documents with specifications
- Improve process clarity with more detailed steps
- Strengthen timeline guidance and application timing
