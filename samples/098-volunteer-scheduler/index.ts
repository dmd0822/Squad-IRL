/**
 * Volunteer Scheduler — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'Matcher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'CommunicationBot', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Volunteer Scheduler\n');
  console.log('👥 Audience: 🏘️ Community');
  console.log('📋 Problem: Coordinate volunteer schedules with availability and skill matching\n');
