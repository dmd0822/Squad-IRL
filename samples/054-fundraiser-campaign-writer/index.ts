/**
 * Fundraiser Campaign Writer — Squad SDK Sample
 *
 * Write compelling fundraiser stories and updates that drive donations
 *
 * Audience: 🏘️ Community
...
const AGENTS = [
  { name: 'Storyteller', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'EmotionExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'DonorPsychologist', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Fundraiser Campaign Writer\n');
  console.log('👥 Audience: 🏘️ Community');
  console.log('📋 Problem: Write compelling fundraiser stories and updates that drive donations\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Fundraiser Campaign Writer`,
    `- **Audience:** 🏘️ Community`,
