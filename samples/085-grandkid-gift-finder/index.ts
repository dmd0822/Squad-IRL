/**
 * Grandkid Gift Finder — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'GiftExpert', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'TrendWatcher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'AgeAppropriateFilter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Grandkid Gift Finder\n');
  console.log('👥 Audience: 👵 Seniors');
  console.log('📋 Problem: Suggest age-appropriate gifts for grandchildren based on trends and interests\n');
  ...
  while (grade < GRADE_THRESHOLD && iteration < MAX_ITERATIONS) {
    ...
    // ── Update Phase ──
    console.log('\n🔄 AgeAppropriateFilter improving...');
