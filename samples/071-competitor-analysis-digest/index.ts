/**
 * Competitor Analysis Digest — Squad SDK Sample
 *
 * Weekly competitor monitoring with strategic insights
 *
...
const AGENTS = [
  { name: 'SpyBot', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'StrategyAnalyst', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'OpportunitySpotter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Competitor Analysis Digest\n');
  console.log('👥 Audience: 🏪 Small Business');
  console.log('📋 Problem: Weekly competitor monitoring with strategic insights\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Competitor Analysis Digest`,
    `- **Audience:** 🏪 Small Business`,
