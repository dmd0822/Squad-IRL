/**
 * Tax Deduction Finder — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'TaxPro', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ReceiptHunter', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'Maximizer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Tax Deduction Finder\n');
  console.log('👥 Audience: 💰 Finance/Everyone');
  console.log('📋 Problem: Scan expenses and identify missed tax deductions and credits\n');
