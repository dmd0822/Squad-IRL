/**
 * Career Path Explorer — Squad SDK Sample
 *
 * Map potential career paths with skills needed and realistic timelines
 *
...
const AGENTS = [
  { name: 'CareerCoach', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ResearchBot', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'RealityChecker', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Career Path Explorer\n');
  console.log('👥 Audience: 🎓 Students/Professionals');
  console.log('📋 Problem: Map potential career paths with skills needed and realistic timelines\n');
