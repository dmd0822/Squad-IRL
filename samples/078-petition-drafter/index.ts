/**
 * Petition Drafter — Squad SDK Sample
 *
 * Write compelling petitions for local change initiatives
 *
...
const AGENTS = [
  { name: 'Organizer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PersuasionExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'CallToActionWriter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Petition Drafter\n');
  console.log('👥 Audience: 🏘️ Community');
  console.log('📋 Problem: Write compelling petitions for local change initiatives\n');
