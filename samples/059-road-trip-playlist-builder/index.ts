...
const AGENTS = [
  { name: 'DJ', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'MoodMatcher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'FlowBuilder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Road Trip Playlist Builder\n');
  console.log('👥 Audience: 🚗 Travelers/Commuters');
  console.log('📋 Problem: Curate road trip playlists that match journey pacing and passenger preferences\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Road Trip Playlist Builder`,
    `- **Audience:** 🚗 Travelers/Commuters`,
