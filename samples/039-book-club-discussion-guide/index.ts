/**
 * Book Club Discussion Guide — Squad SDK Sample
 *
 * Create thoughtful discussion questions and themes for book club meetings
 *
...
const AGENTS = [
  { name: 'Reader', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ThemeSpotter', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ConversationStarter', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Book Club Discussion Guide\n');
  console.log('👥 Audience: 📚 Book Lovers');
  console.log('📋 Problem: Create thoughtful discussion questions and themes for book club meetings\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Book Club Discussion Guide`,
    `- **Audience:** 📚 Book Lovers`,
