/**
 * Artist Statement Generator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'ArtCritic', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Wordsmith', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'AuthenticityGuard', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Artist Statement Generator\n');
  console.log('👥 Audience: 🎨 Artists');
  console.log('📋 Problem: Write compelling artist statements that resonate with galleries and buyers\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Artist Statement Generator`,
    `- **Audience:** 🎨 Artists`,
