...
You are improving a dorm shopping list generator that received feedback from a grader.
...
- Add missing item categories if incomplete
- Improve budget optimization with price tiers
- Strengthen space-saving suggestions for small dorms
- Clarify roommate coordination to reduce duplication
