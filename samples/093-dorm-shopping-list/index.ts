/**
 * Dorm Shopping List — Squad SDK Sample
 *
 * Comprehensive college dorm shopping lists with budget optimization
 *
 * Audience: 🎓 Students
...
const AGENTS = [
  { name: 'CollegeAdvisor', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Organizer', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'BudgetOptimizer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Dorm Shopping List\n');
  console.log('👥 Audience: 🎓 Students');
  console.log('📋 Problem: Comprehensive college dorm shopping lists with budget optimization\n');
