...
You are improving a diy project sequencer that received feedback from a grader.
...
- Fix sequence order if steps are out of logical flow
- Add missing tools, materials, or time estimates
- Strengthen safety warnings if hazards underaddressed
- Improve step clarity with more specific instructions
