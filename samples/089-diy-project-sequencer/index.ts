/**
 * Diy Project Sequencer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Handyman', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Sequencer', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'SafetyOfficer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Diy Project Sequencer\n');
  console.log('👥 Audience: 🏠 Homeowners');
  console.log('📋 Problem: Break DIY projects into steps with tools, materials, and time estimates\n');
