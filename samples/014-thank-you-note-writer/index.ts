/**
 * Thank You Note Writer — Squad SDK Sample
 *
 * Generate personalized thank-you notes that feel genuine
 *
 * Audience: 👰 Events/Everyone
...
const AGENTS = [
  { name: 'Wordsmith', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PersonalityMatcher', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'GratitudeExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Thank You Note Writer\n');
  console.log('👥 Audience: 👰 Events/Everyone');
  console.log('📋 Problem: Generate personalized thank-you notes that feel genuine\n');
