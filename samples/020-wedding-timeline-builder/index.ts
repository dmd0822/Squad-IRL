/**
 * Wedding Timeline Builder — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Coordinator', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'LogisticsExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'BufferBuilder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Wedding Timeline Builder\n');
  console.log('👥 Audience: 👰 Event Planners');
  console.log('📋 Problem: Create minute-by-minute wedding day schedules for all vendors\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Wedding Timeline Builder`,
    `- **Audience:** 👰 Event Planners`,
