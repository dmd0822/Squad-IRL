/**
 * Dating Profile Optimizer — Squad SDK Sample
 *
 * Polish dating profiles to be authentic yet compelling
 *
 * Audience: Everyone
...
const AGENTS = [
  { name: 'Matchmaker', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'AuthenticityGuard', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'PhotoAnalyst', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Dating Profile Optimizer\n');
  console.log('👥 Audience: Everyone');
  console.log('📋 Problem: Polish dating profiles to be authentic yet compelling\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Dating Profile Optimizer`,
    `- **Audience:** Everyone`,
