/**
 * Portfolio Website Writer — Squad SDK Sample
 *
 * Write compelling copy for portfolio websites that convert visitors
 *
 * Audience: 🎨 Artists/Freelancers
...
const AGENTS = [
  { name: 'Copywriter', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'SEOExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'PersonalityCapture', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Portfolio Website Writer\n');
  console.log('👥 Audience: 🎨 Artists/Freelancers');
  console.log('📋 Problem: Write compelling copy for portfolio websites that convert visitors\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Portfolio Website Writer`,
    `- **Audience:** 🎨 Artists/Freelancers`,
