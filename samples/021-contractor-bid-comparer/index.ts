/**
 * Contractor Bid Comparer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Inspector', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PriceAnalyst', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'RedFlagDetector', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Contractor Bid Comparer\n');
  console.log('👥 Audience: 🏠 Homeowners');
  console.log('📋 Problem: Analyze multiple contractor quotes and flag red flags or missing items\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Contractor Bid Comparer`,
    `- **Audience:** 🏠 Homeowners`,
