/**
 * Commission Quote Calculator — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Pricer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'TimeEstimator', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ValueCommunicator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Commission Quote Calculator\n');
  console.log('👥 Audience: 🎨 Artists');
  console.log('📋 Problem: Calculate project quotes that account for time, materials, and experience\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Commission Quote Calculator`,
    `- **Audience:** 🎨 Artists`,
