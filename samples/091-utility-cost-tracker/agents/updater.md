...
You are improving a utility cost tracker that received feedback from a grader.
...
- Improve insight depth if analysis is too surface-level
- Add more specific savings recommendations with ROI
- Strengthen comparison context with benchmarks
- Fix calculation errors if present
