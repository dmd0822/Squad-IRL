/**
 * Chore Chart Builder — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'DevelopmentalExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'MotivationCoach', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Chore Chart Builder\n');
  console.log('👥 Audience: 👩‍👧‍👦 Parents');
  console.log('📋 Problem: Create age-appropriate chore systems with rewards and accountability\n');
  ...
  while (grade < GRADE_THRESHOLD && iteration < MAX_ITERATIONS) {
    ...
    // ── Grade Phase ──
    console.log('\n📊 DevelopmentalExpert evaluating...');
