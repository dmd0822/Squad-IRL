/**
 * Vet Appointment Prep — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'PetAdvocate', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'SymptomLogger', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'QuestionGenerator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Vet Appointment Prep\n');
  console.log('👥 Audience: 🐕 Pet Owners');
  console.log('📋 Problem: Prepare for vet visits with symptom logs and questions to ask\n');
