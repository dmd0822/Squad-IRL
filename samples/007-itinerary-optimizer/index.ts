/**
 * Itinerary Optimizer — Squad SDK Sample
 *
...
const AGENTS = [
  ...
  { name: 'TimeBoss', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'LocalExpert', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Itinerary Optimizer\n');
  console.log('👥 Audience: ✈️ Travelers');
  console.log('📋 Problem: Build day-by-day travel plans that maximize experiences and minimize logistics\n');
