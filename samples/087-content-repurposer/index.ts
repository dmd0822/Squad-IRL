/**
 * Content Repurposer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Adapter', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PlatformExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ContentSlicerBot', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Content Repurposer\n');
  console.log('👥 Audience: 📱 Social Media/Business');
  console.log('📋 Problem: Transform long-form content into multiple platform-specific posts\n');
