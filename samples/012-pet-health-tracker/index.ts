/**
 * Pet Health Tracker — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'VetTech', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'Historian', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
...
async function main(): Promise<void> {
  console.log('🚀 Pet Health Tracker\n');
  console.log('👥 Audience: 🐕 Pet Owners');
  console.log('📋 Problem: Track vet visits, medications, and generate vet appointment prep notes\n');
