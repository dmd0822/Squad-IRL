/**
 * Room Redesign Planner — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Designer', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'SpacePlanner', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'BudgetKeeper', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Room Redesign Planner\n');
  console.log('👥 Audience: 🏠 Homeowners');
  console.log('📋 Problem: Create room makeover plans with furniture layout, color schemes, and shopping list\n');
