...
const AGENTS = [
  { name: 'Scout', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'StatAnalyst', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'OddsCalculator', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Tournament Bracket Analyzer\n');
  console.log('👥 Audience: 🎮 Gamers/Sports');
  console.log('📋 Problem: Analyze tournament matchups and predict outcomes with confidence levels\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Tournament Bracket Analyzer`,
    `- **Audience:** 🎮 Gamers/Sports`,
