/**
 * Grocery Deals Finder — Squad SDK Sample
 *
 * Match weekly grocery needs to local store deals and coupons
 *
 * Audience: 🍳 Foodies/Budgeting
...
const AGENTS = [
  { name: 'DealHunter', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'MealPlanner', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'SavingsMaximizer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Grocery Deals Finder\n');
  console.log('👥 Audience: 🍳 Foodies/Budgeting');
  console.log('📋 Problem: Match weekly grocery needs to local store deals and coupons\n');
