/**
 * Lecture Notes Summarizer — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Librarian', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ConceptExtractor', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'QuizMaker', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Lecture Notes Summarizer\n');
  console.log('👥 Audience: 🎓 Students');
  console.log('📋 Problem: Convert messy lecture notes into organized study material with key concepts\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Lecture Notes Summarizer`,
    `- **Audience:** 🎓 Students`,
