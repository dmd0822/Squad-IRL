/**
 * Moving Checklist Generator — Squad SDK Sample
 *
 * Comprehensive moving checklist with timeline and vendor coordination
 *
 * Audience: 🏠 Everyone
...
const AGENTS = [
  ...
  { name: 'TimelineBoss', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'StressReducer', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
...
async function main(): Promise<void> {
  console.log('🚀 Moving Checklist Generator\n');
  console.log('👥 Audience: 🏠 Everyone');
  console.log('📋 Problem: Comprehensive moving checklist with timeline and vendor coordination\n');
  ...
  saveOutput('final-report.md', [
    '# Review Loop Report',
    '',
    `- **Sample:** Moving Checklist Generator`,
    `- **Audience:** 🏠 Everyone`,
